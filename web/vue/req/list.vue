<template>
    <div>
        <Table @on-selection-change="onSelect" border :columns="tableColumns" :data="tableData"></Table>
    </div>
</template>
...
export default class List extends Vue {
        ...
        },
        {
            ...
            render: (h: Vue.CreateElement, params: any) => {
                return h('Input', {
                    ...
                    on: {
                        'on-change': (event: any) => {
                            this.onChange(params.index, 'desc', event.target.value)
                        }
                    }
                })
            }
    ...
    mounted() {
        ...
        if (this.isHeaders) {
            ...
            this.valueOptions = ['text/plain', 'text/html', 'application/json', 'application/javascript', 'application/xml', 'application/x-www-form-urlencoded']
        }
    }
